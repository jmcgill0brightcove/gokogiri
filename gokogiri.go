...
import (
	"github.com/jmcgill0brightcove/gokogiri/html"
...
found in the github.com/jmcgill0brightcove/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
