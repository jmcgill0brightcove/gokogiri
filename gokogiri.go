...
import (
	"github.com/jmcgill0brigthcove/gokogiri/html"
...
found in the github.com/jmcgill0brigthcove/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
